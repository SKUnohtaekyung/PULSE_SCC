...
| Python test | `.venv\\Scripts\\python.exe -m pytest backend\\python-analysis` | PASS, 6 tests |
...
- 실제 네이버 매장 URL과 OpenAI API 키를 이용한 수집·분석 E2E는 미실행.
- Docker 미설치로 Flyway V3와 PostgreSQL 저장 통합 테스트는 미실행.
